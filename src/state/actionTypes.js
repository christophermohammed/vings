...
export const ADD_TO_NET_SAV = "Add a transaction amount to user's net savings";
export const REMOVE_FROM_NET_SAV = "Remove a transaction amount from user's net savings";
//PHOTOS
